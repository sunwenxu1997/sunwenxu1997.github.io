...
<template>
    <div ref="searchBtnRef"
        ...
        <input ref="searchInputRef" class="select-none outline-none border-0 transition-all"
            :class="searchInputShow ? 'w-20 px-2' : 'w-0 p-0'" type="text" v-model="searchInputValue"
