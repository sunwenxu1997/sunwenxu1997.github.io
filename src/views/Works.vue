...
<template>
    <div class="px-4 sm:px-60 sm:max-w-screen-sm sm:m-auto selection:bg-stone-700 selection:text-white">
        <div class="pt-28 px-8 text-stone-800 text-xs tracking-widest cursor-default" @mouseenter="onMouseenterElement"
            ...
            <p>
                自己也有写相关的文章，主要在平台
                <a class="text-sm text-stone-800 font-bold" href="https://juejin.cn/user/1011206430666551"
                    target="_blank">掘金</a>、
        ...
        <div cursor="search" class="py-12 w-full" v-for="(item, index) in workRoutes" :key="index">
            ...
            <div class="px-8 sm:px-0">
                <div ref="titleRef" class="py-6 flex justify-between">
                    ...
                    <div class="group grid grid-rows-1 grid-flow-col gap-4 cursor-default" @mouseenter="onMouseenterElement"
                        @mouseleave="onMouseleaveElement">
        ...
        <SearchButton ref="searchButtonRef" class="cursor hidden sm:flex" @input="searchInput" />
    </div>
