...
export default {
  ...
  info: ` 
    <p>这个效果是在别的网站上看到的，感觉挺新奇的，尤其很适用于一些家具，灯具类分模块的的价格展示。但是局限性其实也很大，因为图片大小、页面定位都有特定的要求，所以有兴趣的也可以学习一下。主要是了解网格布局的使用。</p>
    <p>知识点：</p>
    <p>1. <code>grid</code> 网格布局；</p>
    <p>2. <code>grid-area</code>网格分区域展示；</p>
    `
}
</script>
<template>
